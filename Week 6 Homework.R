...
# Omitting NA in order to fit parameters
...
####figuring out parameters for psuedo data####
set.seed(123)
...
#Negative Binomial fitting for psuedo data

?rnbinom
new.rk.data = rnbinom(243, size = 0.244, mu = 10.309)
hist(new.rk.data)

#what is the probability of exactly 5 redknot observed at the study site?
pnbinom(q=5, mu = 10.309, size = 0.244)
